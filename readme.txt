...
Consider this plugin “Beta” (in the Google sense) at version 0.8.0 — I will be maintaining the plugin and adding features as I  get requests and time. Just leave a comment on the Feature Request page; If it makes sense to me and does not conflict with my needs for the plugin, I’ll be happy add the feature.
